...
class C_mail extends BaseController
{
	...
	public function new_mail(){
		$validation_rules = [
			'file_surat' => [
				...
				'rules' => [
					'uploaded[file_surat]',
					'max_size[file_surat,102400]',
					'mime_in[file_surat,application/pdf]'
				],
				'errors' => [
					'max_size' => 'Ukuran file melebihi batas yang diperbolehkan (Maks. 100 MB)',
	...
	public function cek_inbox_dir(){
		$list = $this->m_surat->cek_inbox_dir();
		return json_encode($list);
	}
